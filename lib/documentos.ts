 ...
 */
export const DOCUMENTOS_IMPLEMENTADOS: DocumentType[] = ['proposta_comercial', 'orcamento', 'ordem_servico', 'lista_produtos', 'nota_servico', 'nota_produtos', 'laudo_tecnico', 'personalizado'];
