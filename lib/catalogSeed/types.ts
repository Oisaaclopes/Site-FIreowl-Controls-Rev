...
export type TechnicalSeedProduct = Pick<InventoryItem, 'category' | 'brand' | 'productLine' | 'subcategory' | 'model' | 'name' | 'unit' | 'productType' | 'catalogStatus' | 'technologies' | 'stockManaged' | 'catalogOnly'>;
